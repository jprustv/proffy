...
function TeacherForm() {
  ...
  function setScheduleItemValue(position: number, field: string, value: string) {
    const tmpScheduleItemsArray = scheduleItems.map((scheduleItem, index) => {
      if (index === position) {
        return {
          ...scheduleItem,
          [field] : value
    ...
    setScheduleItems(tmpScheduleItemsArray)
  }
      ...
      <main>
        <form onSubmit={handleCreateClass}>
          ...
          <fieldset>
            ...
            />
            <Input name="cost" label="Custo da sa hora por aula" value={cost} onChange={(e) => setCost(e.target.value)}/>
          </fieldset>
